...
@Component({
  selector: 'app-consumption-calendar',
  templateUrl: './consumption-calendar.component.html',
  styleUrls: ['./consumption-calendar.component.css'],
  providers: [DatePipe]
})
export class ConsumptionCalendarComponent implements OnInit {
  ...
  constructor(
    public mconsService: MouldconscalendarService,
...
getBtnClikData(matgroup) {
  ...
  this.monthName = this.datePipe.transform(this.startdate, 'yyyy-MM-dd');
...
eventClick(model) {
  ...
  const me = this;
  this.cols = [
    { field: 'itemcode', header: 'Item code' ,width:'50%'},
    { field: 'description', header: 'Material Name' ,width:'140px'},
    //{ field: 'budat', header: 'Budat' },
    { field: 'pGroup', header: 'Group' ,width:'200px'},
    { field: 'uom', header: 'Uom' },
