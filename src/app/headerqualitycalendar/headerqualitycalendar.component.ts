...
@Component({
  selector: 'app-headerqualitycalendar',
  templateUrl: './headerqualitycalendar.component.html',
  styleUrls: ['./headerqualitycalendar.component.css'],
  providers: [DatePipe]
})

export class HeaderqualitycalendarComponent implements OnInit {  
  currentUser: User;
  plantcode: string;
  options: any;
